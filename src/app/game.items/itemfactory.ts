...
export class ItemFactory {
    ...
    static getMagicShortSword( powers: Map<Power, number> ) {
        return new Weapon( 'Short sword', 1, 6, [WeaponType.OneHanded, WeaponType.Slashing], powers );
    }
    static getMagicGreatSword( powers: Map<Power, number> ) {
        return new Weapon( 'Great sword', 1, 12, [WeaponType.TwoHanded, WeaponType.Slashing], powers );
    }
    ...
    static getMagicFullPlate ( powers: Map<Power, number> ) {
        return new Armor( 'Full plate', 8, ArmorType.Light, powers );
    }
}
